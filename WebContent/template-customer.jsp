		...
		<div class="row">
			...
			<div class="span3">
				...
				<ul id="main-nav" class="nav nav-tabs nav-stacked">
					...
					<li class="active">
						<a href="./viewaccount__getUserInfo.action">
							<i class="icon-home"></i>
							My Account 		
						</a>
					</li>
					...
					<li>
						<a href="./requestcheck_getBalance.action">
					...
					<li>
						<a href="./transactionhistory_getTransactionList.action">
							<i class="icon-check"></i>
							Transaction History	
						</a>
					</li>
