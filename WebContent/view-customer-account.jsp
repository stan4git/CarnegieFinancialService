				...
				<div class="widget widget-table">
					...
					<div class="widget-content">
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
							<s:iterator value="users" status="stuts" id="user">
								<tr>
									<td>${stuts.count}</td>
									...
									<td class="action-td">
										<form action="viewaccount_getUserDetail" method="post">
											<s:hidden name="userName" value="%{#user.userName}"></s:hidden>
											<button type="submit" class="btn btn-small btn-warning">Detail</button>
										</form>
									</td>
								</tr>
							</s:iterator>
